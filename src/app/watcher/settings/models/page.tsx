...
import { ModelsConfigPanel } from "@/features/watcher/components/settings/ModelsConfigPanel";
...
export default function SettingsModelsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-foreground">Modèles LLM</h2>
        <p className="text-sm text-muted-foreground">
          Configuration des modèles de langage utilisés par le Watcher
        </p>
      </div>
